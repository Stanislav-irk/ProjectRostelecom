...
class TestAuth(BaseTest):
    ...
    @pytest.mark.xfail(reason="Продуктовый слоган не соответствует Требованиям_SSO")
    ...
    @pytest.mark.xfail(reason="Название выбора аутентификации по номеру телефона не соответствует Требованиям_SSO")
    ...
    @pytest.mark.xfail(reason="Название формы ввода номера телефона не соответствует Требованиям_SSO")
    ...
    @pytest.mark.xfail(reason="Название формы ввода почты не соответствует Требованиям_SSO")
    ...
    @pytest.mark.xfail(reason="Перенаправление клиента на страницу не соответствует Требованиям_SSO")
